...
export default function Invite() {
    ...
    return (
        <div className="pt-[34px] mx-[31px] pb-[20px]">
            <div className="flex justify-center">
                <img src="/imgs/invite.png" width={180} height={180} alt="" />
            </div>
            <h1 className="mt-[6px] font-poppins font-bold text-[28px] leading-[42px] text-primary text-center">Invite Friend & Earn</h1>
            <div className="mt-[10px] w-[275px] h-[52px] border-[0.5px] border-primary rounded-[7px] mx-auto border-opacity-45 flex justify-evenly">
                <div className="flex items-center gap-[9px]">
                    ...
                    <div className="font-poppins font-bold text-[11px]">
                        ...
                        <div className="text-primary mt-[2px]">100 Onion</div>
                    </div>
                </div>
                <div className="flex items-center gap-[9px]">
                    ...
                    <div className="font-poppins font-bold text-[11px]">
                        ...
                        <div className="text-primary mt-[2px]">200 Onion</div>
                    </div>
                </div>
            </div>
            <div className="mt-[23px]">
                <h2 className="font-medium font-inter text-[16px] leading-[20px]">Earned</h2>
                <div className="mt-[8px] py-[8px] rounded-[12px] flex justify-around bg-[#E5D7D733] font-roboto">
            ...
            <div className="mt-[23px] flex justify-center gap-[13px]">
                <button onClick={handleClickInviteLink} className="w-[195px] h-[36px] rounded-[5px] bg-white text-primary outline outline-1 outline-offset-1 outline-transparent hover:outline-white transition-all duration-300 text-[12px] font-inter font-medium">Invite a Friend</button>
                <button onClick={handleInviteLinkCopyButton} className="w-[90px] h-[36px] rounded-[4px] bg-[#EA5384] outline outline-1 outline-offset-1 hover:outline-primary active:outline-transparent outline-transparent transition-all duration-300 flex items-center justify-center gap-[5px] font-inter font-medium text-[12px]">
                    <img src="/imgs/link.svg" width={16} height={16} alt="" />
                    <span id="copy_button_text">Copy</span>
                </button>
            </div>
            <div className="mt-[38px]">
                <h2 className="font-inter font-semibold text-[18px] leading-[22px]">List of your friends</h2>
